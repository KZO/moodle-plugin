...
//     $settings->add(new admin_setting_configtext('instilledvideo/defaultcontainer', get_string('defaultcontainer', 'instilledvideo'),
//         get_string('defaultcontainer_help', 'instilledvideo'), '', PARAM_TEXT, 50));
// }
